---
title: Bridge/Elevation System - Quick Reference
status: reference
...
- **How It Works**: `docs/features/elevation/bridge-elevation-system.md`
- **Implementation Plan**: `docs/features/elevation/bridge-react-implementation.md`
