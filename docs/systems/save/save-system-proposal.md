---
title: Save System Proposal: Browser Cache + Native .sav Import
status: reference
...
- `docs/systems/save/*.md` - Comprehensive documentation on the native format
...
- `docs/systems/save/gen3-native-save-format.md` - Sector layout and checksums
- `docs/systems/save/gen3-boot-essentials.md` - Minimum required fields
