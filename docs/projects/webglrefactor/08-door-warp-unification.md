---
title: Door/Warp System Unification Plan
status: reference
...
**Source of Truth:** `docs/features/warp/warp-behavior.md` and `public/pokeemerald/src/field_screen_effect.c`
...
3. **GBA Parity**: Easier to verify behavior matches `docs/features/warp/warp-behavior.md`
...
After implementation, verify against `docs/features/warp/warp-behavior.md`:
