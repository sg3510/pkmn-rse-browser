...
- [ ] Render to viewport (see `doc/intro/` for implementation details)
...
├── states/
│   ├── TitleScreenState.ts    # See doc/intro/ for details
│   ├── MainMenuState.ts
...
- `doc/intro/` - Title screen implementation details
- `doc/intro/responsive-design.md` - Scaling strategies
- `doc/game_states/01-overview-and-main-loop.md` - GBA callback pattern
