...
- **Docs:** `doc/save/save-system-analysis.md`, `data-mapping-reference.md`, `emerald-save-import-guide.md` (step-by-step import), `gen3-native-save-format.md`, `pokemon-party-storage-system.md`.
