...
| `doc/save/pokemon-party-storage-system.md` | Data structures reference |
...
From `doc/save/pokemon-party-storage-system.md`, the full Pokemon interface:
...
- `doc/save/pokemon-party-storage-system.md` - Complete data structures
- `doc/save/gen3-party-pokemon-example.md` - Worked encoding example
- `doc/menu/party-menu.md` - Original GBA party menu reference
- `doc/menu/graphics-assets.md` - Asset inventory
