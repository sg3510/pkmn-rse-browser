      ...
      if (refs.debugEnabledRef.current && refs.playerControllerRef.current) {
        ...
        callbacks.setDebugState({
          player: {
            ...
            currentElevation: playerForDebug.getCurrentElevation(),
            previousElevation: playerForDebug.getPreviousElevation(),
            ...
            stateName: playerForDebug.getStateName(),
            hasCollisionChecker: playerForDebug.hasObjectCollisionChecker(),
          },
          tile: null,
